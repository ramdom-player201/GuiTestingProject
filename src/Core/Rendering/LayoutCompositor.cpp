...
void LayoutCompositor::CreatePipeline() {
	...
	VkShaderModule vertModule = CreateShaderModule("data/shaders/compositor.vert.spv");
	VkShaderModule fragModule = CreateShaderModule("data/shaders/compositor.frag.spv");
